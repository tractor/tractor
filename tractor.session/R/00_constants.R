...
.DefaultSessionMap <- list(
    ...
    structural=list(t1="T1w_vol%", t2="T2w_vol%", pd="PDw_vol%", reft1="refT1"),
    freesurfer=list("desikan-killiany"=file.path("mri","aparc+aseg"), destrieux=file.path("mri","aparc.a2009s+aseg")))
