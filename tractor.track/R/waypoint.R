...
findWaypointHits <- function (tract, waypoints, exclusion = FALSE, flag_matchEndPnts = FALSE)
{
    if (!is(tract, "StreamlineCollectionTract"))
        report(OL$Error, "The specified tract is not a StreamlineCollectionTract object")
