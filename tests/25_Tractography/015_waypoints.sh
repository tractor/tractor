...
${TRACTOR} mkroi data/session@FA 50 59 33 PointType:R Width:1 ROIName:tmp/seedregion
${TRACTOR} mkroi data/session@FA 42 66 32 PointType:R Width:3 ROIName:tmp/wpregion1
${TRACTOR} mkroi data/session@FA 58 66 33 PointType:R Width:3 ROIName:tmp/wpregion2
