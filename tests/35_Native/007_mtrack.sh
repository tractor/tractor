...
${TRACTOR} mtrack data/session-12dir SeedMaskFile:tmp/seedregion WaypointMaskFiles:tmp/wpregion1,tmp/wpregion2 TerminationMaskFiles:tmp/wpregion1,tmp/wpregion2 NumberOfSamples:50 TractName:tmp/tract CreateVolumes:true Tracker:tractor
