...
#@data data/images/analyze/maskedb0.*
${TRACTOR} imageinfo $TRACTOR_TEST_DATA/images/analyze/maskedb0 | grep -v source
${TRACTOR} value $TRACTOR_TEST_DATA/images/analyze/maskedb0 50 59 33
